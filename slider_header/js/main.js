// slider pleca
const sliderPleca = document.querySelector("#slider-pleca");
      let sliderSection = document.querySelectorAll(".slider-section-pleca");
      let sliderSectionLast = sliderSection[sliderSection.length -1];

      sliderPleca.insertAdjacentElement('afterbegin', sliderSectionLast);

      function NextPleca() {
        let sliderSectionFirst = document.querySelectorAll(".slider-section-pleca")[0];
        sliderPleca.style.marginLeft = "-200%";
        sliderPleca.style.transition = "all 0.8s";
        setTimeout(function(){
          sliderPleca.style.transition= "none";
          sliderPleca.insertAdjacentElement('beforeend', sliderSectionFirst);
          sliderPleca.style.marginLeft = "-100%";
        },800);
      }
      function PrevPleca() {
        let sliderSection = document.querySelectorAll(".slider-section-pleca");
        let sliderSectionLast = sliderSection[sliderSection.length -1];
        sliderPleca.style.marginLeft = "0";
        sliderPleca.style.transition = "all 0.8s";
        setTimeout(function(){
          sliderPleca.style.transition= "none";
          sliderPleca.insertAdjacentElement('afterbegin', sliderSectionLast);
